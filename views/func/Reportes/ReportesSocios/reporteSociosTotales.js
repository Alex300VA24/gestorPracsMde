// Funcion para mostrar los mensajes toastr
$(document).ready(function () {
  ...
  $('#reporteSociosTotaless').click(function () { //ahi llamo al id del  boton
      ...
      success: function (data) {
        ...
        try {
          ...
          doc.autoTable({ //aqui viene la libreria que te mencione para el diseño de la tabla 
            ...
            head: [['N°', 'CODIGO GRUPO','APELLIDO PATERNO', 'APELLIDO MATERNO', 'FECHA INICIO', 'CLUB DE MADRES', 'EDAD']], //mi cabecera de la tabla
          ...
          toastr.success('Reporte de socios totales generado.', 'Mensaje');
          // Retrasar la apertura del PDF y limpiar el campo de entrada
          setTimeout(() => {
            window.open(doc.output('bloburl'), '_blank');
          }, 2000); 
        } catch (error) { 
          toastr.error('Hubo un error al generar el reporte de socios totales.', 'Mensaje de error'); 
          console.error('Error al generar el PDF:', error.message); 
        }
      },
      // si es rror me muestra mensaje que no se puede crear pdf
      error: function (xhr, status, error) {
        toastr.error('Hubo un error al obtener el reporte de los socios totales.', 'Mensaje de error'); 
