...
------------------- SECUNDARIA ----------------------------
insert into Sectores(descripcion) values('Wichanzao'),('Central'),('Jerusalï¿½n');
...
values('niï¿½o (0-6 aï¿½os)', 0, 6, 1, ''),('niï¿½o (7-13 aï¿½os)', 7, 13, 2, ''),
...
values
('Larri Rodrigo Estrada Leï¿½n', 'lestradal', 'admin', '71086437', '9',1, 1),
...
INSERT INTO Personas(nombres, apellidoPaterno, apellidoMaterno, dni, sexo, telefono, celular,
        ...
        numeroFinca)
VALUES 
    ('Marï¿½a Alejandra', 'Lï¿½pez', 'Rodrï¿½guez', '12345678', 'f', null, '912345678', '1990-04-15', 1, 'Av. Primavera 100', null),
    ('Ana Sofï¿½a', 'Garcï¿½a', 'Mendoza', '23456789', 'f', null, '912345679', '1992-08-22', 2, 'Calle Olivo 200', null),
    ('Valeria Isabel', 'Morales', 'Jimï¿½nez', '34567890', 'f', null, '912345680', '1988-12-11', 3, 'Paseo de las Flores 300', null),
    ('Daniela Fernanda', 'Ruiz', 'Pï¿½rez', '45678901', 'f', null, '912345681', '1991-06-09', 4, 'Av. Los Nogales 400', null),
    ('Camila Victoria', 'Castro', 'Ramï¿½rez', '56789012', 'f', null, '912345682', '1993-01-25', 5, 'Calle Las Rosas 500', null),
    ('Laura Gabriela', 'Torres', 'Sï¿½nchez', '67890123', 'f', null, '912345683', '1989-10-14', 1, 'Av. Los Pinos 600', null),
    ('Sara Lucï¿½a', 'Rï¿½os', 'Fernï¿½ndez', '78901234', 'f', null, '912345684', '1990-05-07', 2, 'Paseo del Bosque 700', null),
    ('Paula Andrea', 'Castillo', 'Gï¿½mez', '89012345', 'f', null, '912345685', '1987-03-03', 3, 'Calle Los ï¿½lamos 800', null),
    ('Elena Patricia', 'Delgado', 'Torres', '90123456', 'f', null, '912345686', '1994-09-19', 4, 'Av. Los Robles 900', null),
    ('Rosa Emilia', 'Martï¿½nez', 'Campos', '01234567', 'f', null, '912345687', '1995-02-28', 5, 'Calle Las Acacias 1000', null),
    ('Julia Alejandra', 'Fernï¿½ndez', 'Lï¿½pez', '12345679', 'f', null, '912345688', '1988-11-10', 1, 'Calle Santa Rosa 110', null),
    ('Gabriela Estefanï¿½a', 'Vï¿½squez', 'Martï¿½n', '23456780', 'f', null, '912345689', '1991-02-20', 2, 'Av. del Sol 220', null),
    ('Carla Andrea', 'Pï¿½rez', 'Castillo', '34567891', 'f', null, '912345690', '1993-04-15', 3, 'Calle Las Palmas 330', null),
    ('Verï¿½nica Elena', 'Hernï¿½ndez', 'Salazar', '45678902', 'f', null, '912345691', '1990-08-02', 4, 'Av. San Martï¿½n 440', null),
    ('Patricia Isabel', 'Mora', 'Quispe', '56789013', 'f', null, '912345692', '1989-05-29', 5, 'Calle Las Lilas 550', null),
    ('Nancy Julieta', 'Torres', 'Cruz', '67890124', 'f', null, '912345693', '1992-07-12', 1, 'Paseo del Rï¿½o 660', null),
    ('Inï¿½s Carolina', 'Ramos', 'Aldana', '78901235', 'f', null, '912345694', '1994-09-05', 2, 'Calle El Manzano 770', null),
...
=======
    ('Silvia Estela', 'Nï¿½ï¿½ez', 'Paredes', '90123457', 'f', null, '912345696', '1990-12-11', 4, 'Calle Las Guayabas 990', null),
    ('Mï¿½nica Patricia', 'Soto', 'Martï¿½nez', '01234568', 'f', null, '912345697', '1993-03-26', 5, 'Calle El Sauce 1000', null);
>>>>>>> 2a2fcf8da7269a916a07afba7933a4c9faa14936
