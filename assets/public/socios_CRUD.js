$(document).ready(function () {
      ...
      success: function (response) {
        ...
        if (code === 200) {
          ...
          let cardBeneficiario = data.map(beneficiario => {
            ...
            return `
                        <div class="card-beneficiario ${tipoBeneficioBeneficiario.includes("niño") && sexoBeneficiario == 'm' ? 'card-boy' :
  ...
  $(document).off("click", "#btnInhabilitarSocio").on("click", "#btnInhabilitarSocio", function (e) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        console.log('Codigo del socio', codSocio)
  ...
  $(document).off("submit", "#registrarNuevoBeneficiarioForm").on('submit', '#registrarNuevoBeneficiarioForm', function (e) {
    ...
    console.log({
      codSocio, dniSocio, dniBeneficiario, nombresBeneficiario, apellidoPaternoBeneficiario, apellidoMaternoBeneficiario,
